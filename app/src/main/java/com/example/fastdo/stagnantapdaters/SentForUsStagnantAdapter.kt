...
class SentForUsStagnantAdapter(
     options: FirebaseRecyclerOptions<SearchStagnantModel?>?, var context: Context
) : FirebaseRecyclerAdapter<SearchStagnantModel?, SentForUsStagnantAdapter.StagnantViewHolder>(
    options!!
) {
    ...
    override fun onCreateViewHolder(
        ...
        val view: View = LayoutInflater.from(parent.context)
            .inflate(R.layout.sent_for_us_stagnants_model, parent, false)
